...
struct ImFontAtlas
{
    ...
    IMGUI_API ImFont*           AddFontBlank(const ImFontConfig* font_cfg = NULL);
    ...
    IMGUI_API const ImWchar*    GetGlyphRangesNone();                   // Empty
    IMGUI_API const ImWchar*    GetGlyphRangesGreek();                 // Default + Greek characters
